...
void ChooseLevel::LevelText(CDC *pDC) {
	...
	for (int i = 0; i < 18; i++) {
		if (i >= 1 && i <= 5) {
			...
			text_art.TextBorder(pDC, button_x + 21 + (i % 6) * 100, button_y + 21, 4, std::to_string(i));
			...
			CTextDraw::ChangeFontLog(pDC, 20, "Press Start 2P", RGB(0, 0, 0));
			text_art.TextBorder(pDC, button_x + 21 + (i % 6) * 100, button_y + 21 + 100, 4, std::to_string(i));
			CTextDraw::ChangeFontLog(pDC, 20, "Press Start 2P", RGB(255, 255, 255));
			CTextDraw::Print(pDC, button_x + 21 + (i % 6) * 100, button_y + 21 + 100, std::to_string(i));
		}
		else if (i >= 10 && i <= 11) {
			CTextDraw::ChangeFontLog(pDC, 20, "Press Start 2P", RGB(0, 0, 0));
			text_art.TextBorder(pDC, button_x + 7 + (i % 6) * 100, button_y + 21 + 100, 4, std::to_string(i));
			CTextDraw::ChangeFontLog(pDC, 20, "Press Start 2P", RGB(255, 255, 255));
			CTextDraw::Print(pDC, button_x + 7 + (i % 6) * 100, button_y + 21 + 100, std::to_string(i));
		}
		else if (i >= 12 && i <= 16) {
			CTextDraw::ChangeFontLog(pDC, 20, "Press Start 2P", RGB(0, 0, 0));
			text_art.TextBorder(pDC, button_x + 7 + (i % 6) * 100, button_y + 21 + 200, 4, std::to_string(i));
			CTextDraw::ChangeFontLog(pDC, 20, "Press Start 2P", RGB(255, 255, 255));
